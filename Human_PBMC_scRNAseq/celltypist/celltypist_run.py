...
RNA = sc.read('/gpfs/data/giannarellilab/Mike_G/Immune_checkpoint_inhibitors/CHORD_PBMC/pbmc_obj_rm_doub_RNA.h5ad')
integrated = sc.read('/gpfs/data/giannarellilab/Mike_G/Immune_checkpoint_inhibitors/CHORD_PBMC/pbmc_obj_rm_doub_integrated.h5ad')

...
Whole_dataset_annotated_human.rds_sub <- subset(Whole_dataset_annotated_human.rds, idents = 'DM2')
Idents(Whole_dataset_annotated_human.rds_sub) <- 'Condition'
Whole_dataset_annotated_human.rds_sub <- subset(Whole_dataset_annotated_human.rds_sub, idents = 'LL')
...
saveRDS(cellchat, file = '/gpfs/data/giannarellilab/Mike_G/Immune_checkpoint_inhibitors/CHORD_PBMC/Cellchat/cellchat_fine_1_LL_DM2.rds')

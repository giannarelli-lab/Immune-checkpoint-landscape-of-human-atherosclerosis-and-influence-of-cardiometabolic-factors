...
Whole_dataset_annotated_human.rds_sub <- subset(Whole_dataset_annotated_human.rds, idents = 'LL')
...
saveRDS(cellchat, file = '/gpfs/data/giannarellilab/Mike_G/Immune_checkpoint_inhibitors/CHORD_PBMC/Cellchat/cellchat_fine_1_LL.rds')

...
Whole_dataset_annotated_human.rds_sub <- subset(Whole_dataset_annotated_human.rds, idents = 'Type_2')
...
saveRDS(cellchat, file = '/gpfs/data/giannarellilab/Mike_G/Immune_checkpoint_inhibitors/cellchat/rerun_ICdb_issue/cellchat_fine_1_Type_2.rds')

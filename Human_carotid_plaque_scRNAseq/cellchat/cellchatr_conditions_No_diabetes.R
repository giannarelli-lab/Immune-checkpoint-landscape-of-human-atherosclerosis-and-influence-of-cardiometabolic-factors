...
Idents(Whole_dataset_annotated_human.rds) <- 'conditions'
Whole_dataset_annotated_human.rds_sub <- subset(Whole_dataset_annotated_human.rds, idents = 'No_diabetes')
...
future::plan("multisession", workers = 39) # do parallel (doesnt work via Rstudio)
...
saveRDS(cellchat, file = '/gpfs/data/giannarellilab/Mike_G/Immune_checkpoint_inhibitors/cellchat/rerun_ICdb_issue/cellchat_fine_1_No_diabetes.rds')
